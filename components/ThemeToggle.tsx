...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="w-9 h-9 rounded-full flex items-center justify-center border border-[var(--border)] bg-[var(--card)] hover:border-[var(--gold)] transition-all duration-300 hover:scale-110"
    >
      {isDark ? (
        // Soleil
